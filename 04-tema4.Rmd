...
Existe interacción cuando $\alpha\beta_{jk} \neq$ 0 para algún *jk*. @pardo consideran que esta expresión puede interpretarse de dos formas:
...
```{r, echo=FALSE,fig.cap= "Datos del ejemplo 4.1",out.width="70%",fig.align='center'}
...
ta2<- xtable(levene,caption= "Prueba de Levene del ejemplo 4.1")
#print(ta2, comment = F)

knitr:: kable(round(mod,2), caption = "Resultados del ejemplo 4.1")
...
knitr:: kable(round(levene,2), caption = "Prueba de Levene del ejemplo 4.1")
...
```{r, echo=FALSE,fig.cap= "Representación gráfica del ejemplo 4.1",out.width="70%",fig.align='center'}
...
library(tidyr)
library(kableExtra)
#knitr::include_graphics("figurasR/MediasEjemplo33-1.png")
medias<- c(6.6,11,6.6,6.4,7,7)
# tab42<- matrix(medias,1,6,byrow=T, dimnames= list(c("Medias"),c("$\overline{X}_{a_1b_1}$","$\overline{X}_{a_2b_1}$","$\overline{X}_{a_1b_2}$", "$\overline{X}_{a_2b_2}$", "$\overline{X}_{a_1b_3}$", "$\overline{X}_{a_2b_3}$")))
tab42<- matrix(medias,1,6,byrow=T, dimnames= list(c("Medias"),c("$a_1b_1$","$a_2b_1$","$a_1b_2$", "$a_2b_2$", "$a_1b_3$", "$a_2b_3$")))
tab42b<- knitr:: kable(tab42, "html",caption = "Medias de las condiciones del ejemplo 4.1")
kableExtra:: row_spec(tab42b,0,bold = T)
```
...
```{r, echo=FALSE}
x<- c(1.95,1.82,2,1.87,1.95,1.87)
tab43<- matrix(x,1,6,byrow=T, dimnames= list(c("valor"),c("$s_{a_1b_1}$","$s_{a_2b_1}$","$s_{a_1b_2}$", "$s_{a_2b_2}$", "$s_{a_1b_3}$", "$s_{a_2b_3}$")))

tab43b<-knitr:: kable(tab43, caption = "Desviaciones tipo de las condiciones del ejemplo 4.1")
kableExtra::row_spec(tab43b,row =0, bold = T)
...
```{r, echo=FALSE,fig.cap= "Boxplot del ejemplo 4.2",out.width="400px",fig.align='center'}
...
```{r, echo=FALSE,fig.cap= "Resultados del ejemplo 4.2",fig.align='center',out.width="450px"}
knitr::include_graphics("figurasR/anova_ejemplo2.png")
```



```{r, echo=FALSE,fig.cap= "Prueba de Tuckey para las comparaciones de edad del ejemplo 4.2",out.width="400px",fig.align='center'}
...
```{r, echo=FALSE,fig.cap= "Resultado de la interacción del ejemplo 4.1",fig.align='center',out.width="50%"}
...
```{r, echo=FALSE,fig.cap= "Resultado de la interacción del ejemplo 4.1",fig.align='center',out.width="70%"}
...
```{r, echo=FALSE,fig.cap= "Representación gráfica del ejemplo 4.1",fig.align='center',out.width="60%"}
knitr::include_graphics("figurasR/fact_ejemplo31_jamovi.png")
```

```{r, echo=FALSE,fig.cap= "Comparación de los efectos simples del ejemplo 4.1",out.width="70%",fig.align='center'}
