...
```{r, echo=FALSE, out.width="90%", fig.cap="Relación entre la edad y BOSTON1"}
knitr::include_graphics("figurasR/regBoston1Edad.png")
```


```{r,fig0,echo=FALSE,fig.height= 3,fig.cap = 'Relación entre la edad y BOSTON 1',eval=FALSE,resulTS='asis',message=FALSE}
library(ggplot2)
...
```{r, echo=FALSE, out.width="90%", fig.cap="Relación entre las medidas de BOSTON2 y BOSTON1"}
knitr::include_graphics("figurasR/regBoston1Boston2.png")
```


```{r,fig1,echo=FALSE,fig.height=3,fig.cap = 'Relación entre las dos medidas del Boston' , results='asis', message=FALSE,eval=FALSE}
...
```{r,reg1,echo=FALSE,results='markup'}
...
```{r,reg2,echo=FALSE,results='markup'}
...
```{r,reg3,echo=FALSE,results='markup'}
...
```{r, echo=FALSE, out.width="90%", fig.align ="center",fig.cap="Relación entre la edad y el BOSTON1 en función del sexo"}
knitr::include_graphics("figurasR/rmSexo.png")
```
...
```{r,rm1,echo=FALSE,results='markup', message=FALSE,warning=FALSE}
