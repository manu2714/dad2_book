...
```{r, echo=FALSE, out.width="90%", fig.cap="Relación entre la edad y el BOSTON1 en función del sexo"}
knitr::include_graphics("figurasR/rmSexo.png")
```


```{r,fig3,echo=FALSE,fig.height= 3,fig.cap = 'Relación entre la edad y el Boston 1 en función del género',results='asis',fig.align='center',message=FALSE,eval=FALSE}
...
```{r,rm1,echo=FALSE,results='asis', message=FALSE,warning=FALSE}
