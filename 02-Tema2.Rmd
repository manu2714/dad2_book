...
Es necesario determinar si las muestras son independientes. Esto se asume siempre y cuando hayan sido extraídas al azar [^2.2]. Asimismo, se necesita determinar sin las muestras proceden de una población normal con la misma varianza. Asimismo, tendremos que comprobar que la distribución de los errores sigue una ley normal. 
...
La propuesta de Welch es otra alternativa cuando no se cumple el supuesto de homogeneidad de varianzas. Su expresion es:
